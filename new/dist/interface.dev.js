...
function updatePopulationPage(n) {
  const
    ...
    decryptionsDisplay = page.querySelector(".decryptions");

  decryptionsDisplay.querySelector(".best-key").innerHTML = bestKey;
  decryptionsDisplay.querySelector(".best-score").innerHTML = knownScores[bestKey];
  decryptionsDisplay.querySelector(".best-decryption").innerHTML = "Decryption not yet implemented for this cipher :|";
}
*/
// sidebar
