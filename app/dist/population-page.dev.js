...
function (_HTMLElement) {
  _inherits(PopulationPage, _HTMLElement);

  function PopulationPage() {
    var _this;

    _classCallCheck(this, PopulationPage);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(PopulationPage).call(this));
